...
class BiometrieCpl(ContractDTO):
    ...
    def __init__(self,contract_nr):
        ...
        self.LifeTable= LifeTable(contract_nr=contract_nr)
    ...
    def q_x(self, birthDate:int):
        ...
        for age in range(0, Max_Age + 1):
            qx_m = self.q_x_dict[age] * exp(-(birthDate + age - 1999) * self.trend_dict[age])
            QX_M.append(qx_m)
        return QX_M
    ...
    def nYearSurvivalProbability(self, n, age, birthDate):
        ...
        return result
print(BiometrieCpl(contract_nr=1234).q_x(1960))