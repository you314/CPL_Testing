...
class LifeTable:
    ...
    def __init__(self): #contract_nr):
        ...
        self.tg_dict = self.csv_reader.read_column_from_csv("tariff_name", type=str)
    ...
    def death_probability_table(self) -> str:
        ...
        tg_index = self.tg_list.index(self.contractDTO.tariff_name())  # gets the index of the required tariff generation
